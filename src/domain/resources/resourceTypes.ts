...
export type ResourceType = "stone" | "wood" | "food" | "gold" | "cloth" | "herb" | "ore";

/** Resources held in the Warehouse and capped by its level. Gold is uncapped in v1 (Vault is v2). */
export const STORABLE_RESOURCES: readonly ResourceType[] = [
  "stone",
  "wood",
  "food",
  "cloth",
...
export const COLLECTABLE_RESOURCES = ["stone", "wood", "food", "ore"] as const;
